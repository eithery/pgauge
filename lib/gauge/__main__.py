def main():
    HEADER = ('pyGauge. Version 0.0.1\n'
        'Command-line assistant and toolbox for MS SQL server\n\n'
        'usage: pgauge [-v|--version] [-h|--help] [-s|--server] [-u|--user] [-p|--password]\n'
    ...
    COMMANDS = ('The most commonly used gauge commands are:\n'
        ...
        "See 'pgauge help <command>' for more information on a specific command.")
